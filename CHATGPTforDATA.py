...
if df.shape[0] > 0:
    agent = create_pandas_dataframe_agent(OpenAI(temperature=0), df,openai_api_key="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", verbose=True, return_intermediate_steps=True, agent_type=AgentType.ZERO_SHOT_REACT_DESCRIPTION)
    user_input = get_text()
